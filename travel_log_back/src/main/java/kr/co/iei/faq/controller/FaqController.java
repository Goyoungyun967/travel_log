...
public class FaqController {
	...
	@GetMapping(value="/faq/{faqType}")
	@Operation(summary = "타입으로 faq리스트 조회",description = "타입을 받아서 faq리스트 조회")
	...
	@Operation(summary = "번호로 faq 조회",description = "faq번호를 받아서 faq내용 조회")
