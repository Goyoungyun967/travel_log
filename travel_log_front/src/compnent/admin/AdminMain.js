            ...
            <div className="admin-wrap">
                ...
                <div className="admin-menu-bar">
                    ...
                    <ul className="admin-sub-menu">
                        <li><NavLink to="1">신고 회원 관리</NavLink></li>
                        <li><NavLink to="2">회원 이용 관리</NavLink></li>
                        <li><NavLink to="inquiryList">1대1 문의 처리</NavLink></li>
                    </ul>
                    <ul className="admin-main-menu" onClick={changeMenu}>
                        <li>게시물 관리</li>
                        <span className="material-icons">expand_more</span>
                    ...
                    <ul className="admin-sub-menu">
                        <li><NavLink to="3">상품 게시글 관리</NavLink></li>
                        <li><NavLink to="4">신고 리뷰 관리</NavLink></li>
                        <li><NavLink to="5">신고 게시글 관리</NavLink></li>
                    </ul>
                    <ul className="admin-main-menu" onClick={changeMenu}>
                        <li>판매자 관리</li>
                        <span className="material-icons">expand_more</span>
                    ...
                    <ul className="admin-sub-menu">
                        <li><NavLink to="6">판매자 가입 승인</NavLink></li>
                        <li><NavLink to="7">판매자 매출</NavLink></li>
                        <li><NavLink to="8">판매자 정산</NavLink></li>
                    </ul>
                </div>
