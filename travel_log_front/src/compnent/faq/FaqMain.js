      ...
      <div className="faq-wrap">
        ...
        <div className="faq-menu-bar">
          ...
          {faqTypeList.map((faqType, index) => {
            return (
              <div key={"faqTypeCategory" + index}>
                <ul
                  className="faq-main-menu"
                  onClick={(e) => {
                ...
                >
                  ...
                  <span className="material-icons">
                    {menuState[index] ? "expand_less" : "expand_more"}
                  </span>
                </ul>
        ...
        <div className="faq-content-wrap">
          <Routes>
            <Route
              path="faqList/:faqType/:categoryIndex"
              element={<FaqList faqTypeList={faqTypeList} />}
            />
            <Route
              path="faqWrite"
              element={<FaqWrite faqTypeList={faqTypeList} />}
            />
            <Route
              path="faqUpdate/:faqNo/:categoryIndex"
              element={<FaqWrite faqTypeList={faqTypeList} />}
            />
          </Routes>
        </div>
